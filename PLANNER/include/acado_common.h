...
/** Matrix of size: 81 x 12 (row major format)
 * 
...
/** Matrix of size: 160 x 2 (row major format) */
real_t R1[ 320 ];
...
/** Matrix of size: 12960 x 2 (row major format) */
real_t E[ 25920 ];
...
/** Matrix of size: 164 x 164 (row major format) */
real_t H[ 26896 ];

/** Matrix of size: 400 x 164 (row major format) */
real_t A[ 65600 ];
